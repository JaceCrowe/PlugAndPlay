...
import Open1 from './routes/open1';
import Open2 from './routes/open2';
import Open3 from './routes/open3';
import Open4 from './routes/open4';
    ...
    children: [
      {
        ...
        children: [
          ...
          // Add path to components for React Router Here:
          {
            path: "open1",
            element: <Open1 />
          },
